...
<nav class="navbar navbar-inverse">
  <div class="container-fluid ">
    ...
    <ul class="nav navbar-nav">
      <li class=""><a href="#sanjay">SCHEMES</a></li>
      <li><a href="#gupta">Information of Harvesting</a></li>
    ...
    <div class="test-bg d-flex flex-row">
    ...
    <img src="Farm6.jpg" width="650" height="300" class="img1">
</div> 
<div class="test-bg1 d-flex flex-row">
   ...
   <img src="Farm7.jpg" width="650" height="300" class="img1">
</div>
  ...
  <div class="test-bg2 d-flex flex-row"> 
    ...
    <div class="test-bg3 d-flex flex-row"> 
        ...
        <div class="test-bg4 d-flex flex-row"> 
